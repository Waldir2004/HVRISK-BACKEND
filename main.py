...
from routes.historial_usuario_router import router as historial_router
from routes.enfermedades_router import router as enfermedades_router
from routes.categorias_enfermedades_router import router as categorias_enfermedades_router
from routes.auth_routes import router as auth_router
from routes.permisos_router import router as permisos_router
from routes.prediccion_routers import router as prediccion_router
...
app.include_router(enfermedades_router)
app.include_router(categorias_enfermedades_router)
